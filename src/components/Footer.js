...
function Footer() {
  ...
  // for copy the mobile number to clipboard
    ...
    const copyToClipBoard = (text) => {
      ...
      textArea.select();
      //then put the command for copy
      document.execCommand("copy");
      //remove the textarea to the document
  ...
  return (
    <Container fluid className="fotter">
      <div className="fotter-di">
        <Row className="fotter-top">
          ...
          <Col lg="4" md="4" sm="4" xs="6">
            <div className="fotter-column">
              <ul>
                ...
                {/* <li>press</li> */}
                {/* <li>Legal & privacy</li> */}
                <li onClick={() => copyToClipBoard("1234567890")}>
                  1234567890
                </li>{" "}
                <li title="mail to us"><a href="mailto:deenakannan3@gmail.com" className="fott-mail" title="mail to us">abc@gmail.com</a></li>
              </ul>
            </div>
          </Col>
