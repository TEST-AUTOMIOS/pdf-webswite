        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Separate one page or a whole set for<br></br>easy conversion into
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Easily convert your PDF files into easy<br></br>to edit DOC and
              DOCX documents. 
            </p>
          </div>
        </div>
        ...
        <div className="card ">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Turn your PDF files into easy to edit<br></br> PPT and PPTX
              slideshows.
            </p>
          </div>
        </div>
        ...
        <div className="card ">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Pull data straight from PDFs into Excel<br></br>spreadsheets in a
              few short seconds.
            </p>
          </div>
        </div>
        ...
        <div className="card ">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Convert each PDF page into a JPG or<br></br> extract all images
              contained in a PDF
            </p>
          </div>
        </div>
        ...
        <div className="card ">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Make PPT and PPTX slideshows east to<br></br>view by converting
              them to PDF.
            </p>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Sign yourself or request electronic<br></br>signatures from
              others.
            </p>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Stamp an image or text over your PDF<br></br> in seconds. Choose
              the typography,<br></br> transparency and position.
            </p>
          </div>
        </div>
        </Link>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Rotate your PDFs the way you need<br></br> them. You can even
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Convert webpages in HTML to PDF.<br></br> Copy and paste the URL
              of the page you<br></br> want and convert it to PDF with a click.
            </p>
          </div>
        </div>
        </Link>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Remove PDF password security, giving<br></br> you the freedom to
              use your PDFs as<br></br> you want.
            </p>
          </div>
        </div>
        </Link>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Protect PDF files with a password.<br></br> Encrypt PDF documents
              to prevent<br></br> unauthorized access.
            </p>
          </div>
        </div>
        </Link>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
                Sort pages of your PDF file however you like. Delete PDF pages or add PDF<br></br> pages to your<br></br> document at your convenience.
            </p>
          </div>
        </div>
        </Link>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Transform your PDF to PDF/A, the ISO <br></br>standardized version
              of PDF for long-term<br></br>
            </p>
          </div>
        </div>
        </Link>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Repair a damaged PDF and recover<br></br> data from corrupt PDF.
              Fix PDF files<br></br> with our Repair tool.
            </p>
          </div>
        </div>
        </Link>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Capture document scans from your<br></br> mobile device and send
              them instantly<br></br> to your browser.
            </p>
          </div>
        </div>
        </Link>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p
              ...
              style={{ fontSize: "13px", color: "grey" }}
            >
              Easily convert scanned PDF into <br></br>searchable and selectable
              documents.
            </p>
          </div>
        </div>
