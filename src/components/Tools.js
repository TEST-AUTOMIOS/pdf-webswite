    ...
    <div className="tools">
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Separate one page or a whole set for<br></br>easy
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Reduce file size while optimizing for<br></br> maximal PDF
                      quality.
                    </p>
                  </div>
                </div>
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Easily convert your PDF files into easy<br></br>to edit
      ...
      <div className="container">
        <Row className="card-height">
          <div className="card-group">
            <Col lg="3" md="3" sm="6" xs="12" className="car-bot">
              <Link to={"/excelpdf"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Make EXCEL spreadsheets easy to <br />
                      read by converting them to PDF
                    </p>
                  </div>
                </div>
              </Link>
            ...
            <Col lg="3" md="3" sm="6" xs="12" className="car-bot">
              <Link to={"/editpdf"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Add text, images, shapes or freehand <br />
                      annotations to a PDF document. Edit
                      <br /> the size, font, and color of the added content.
                    </p>
                  </div>
                </div>
              </Link>
            ...
            <Col lg="3" md="3" sm="6" xs="12" className="car-bot">
              <Link to={"/pdftojpg"} className="link-tools">
                <div className="card">
                  <svg
                  style={{padding:'5px'}}
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <Col lg="3" md="3" sm="6" xs="12" className="car-bot">
              <Link to={"/jpgtopdf"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5PX" }}
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                    Convert JPG images to PDF in
                     seconds. Easily adjust orientation and
                      margins
                    </p>
                  </div>
                </div>
      ...
      <div className="container">
        <Row className="card-height">
          <div className="card-group">
            <Col>
              <Link to={"/pdftopowerpoint"} className="link-tools">
                <div className="card ">
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Turn your PDF files into easy to edit<br></br> PPT and
                      PPTX slideshows.
                    </p>
                  </div>
                </div>
            ...
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/pdftoexcel"} className="link-tools">
                <div className="card ">
                  {/* <img src="..." className="card-img-top" alt="..."> */}
                  <svg
                    style={{ padding: "5px" }}
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Pull data straight from PDFs into Excel<br></br>
                      spreadsheets in a few short seconds.
                    </p>
                  </div>
                </div>
              </Link>
            ...
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/wordtopdf"} className="link-tools">
                <div className="card ">
                  {/* <img src="..." className="card-img-top" alt="..."> */}
                  <svg
                    style={{ padding: "5px" }}
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Convert each PDF page into a JPG or<br></br> extract all
            ...
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/powerpointtopdf"} className="link-tools">
                <div className="card ">
                  {/* <img src="..." className="card-img-top" alt="..."> */}
                  <svg
                    style={{ padding: "5px" }}
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Make PPT and PPTX slideshows east to<br></br>view by
      ...
      <div className="container">
        <Row className="card-height">
          <div className="card-group">
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/signpdf"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Sign yourself or request electronic<br></br>signatures
                      from others.
                    </p>
                  </div>
                </div>
            ...
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/watermark"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Stamp an image or text over your PDF<br></br> in seconds.
                      Choose the typography,<br></br> transparency and position.
                    </p>
                  </div>
                </div>
              </Link>
            ...
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/rotatepdf"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Rotate your PDFs the way you need<br></br> them. You can
                      even rotate multiple PDFs at once!
                    </p>
                  </div>
                </div>
              </Link>
            ...
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/htmltopdf"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Convert webpages in HTML to PDF.<br></br> Copy and paste
                      the URL of the page you<br></br> want and convert it to
                      PDF with a click.
                    </p>
                  </div>
                </div>
      ...
      <div className="container">
        <Row className="card-height">
          <div className="card-group">
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/unlockpdf"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Remove PDF password security, giving<br></br> you the
                      freedom to use your PDFs as<br></br> you want.
                    </p>
                  </div>
                </div>
              </Link>
            ...
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/protectpdf"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Protect PDF files with a password.<br></br> Encrypt PDF
                      documents to prevent<br></br> unauthorized access.
                    </p>
                  </div>
                </div>
              </Link>
            ...
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/organizepdf"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Sort pages of your PDF file however you like. Delete PDF
                      pages or add PDF<br></br> pages to your<br></br> document
                      at your convenience.
                    </p>
                  </div>
                </div>
            ...
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/pdftopdfa"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Transform your PDF to PDF/A, the ISO <br></br>standardized
                      version of PDF for long-term<br></br>
                    </p>
                  </div>
                </div>
              </Link>
      ...
      <div className="container">
        <Row className="card-height">
          <div className="card-group">
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/repairpdf"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Repair a damaged PDF and recover<br></br> data from
                      corrupt PDF. Fix PDF files<br></br> with our Repair tool.
                    </p>
                  </div>
                </div>
              </Link>
            ...
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/pagenumber"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Add page numbers into PDFs with<br></br> ease. Choose your
                      positions,<br></br> dimensions, typography.
                    </p>
                  </div>
                </div>
              </Link>
            ...
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/scantopdf"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    width="48"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Capture document scans from your<br></br> mobile device
                      and send them instantly<br></br> to your browser.
                    </p>
                  </div>
                </div>
              </Link>
            ...
            <Col lg="3" md="3" sm="6" xs="12">
              <Link to={"/ocrtopdf"} className="link-tools">
                <div className="card">
                  <svg
                    style={{ padding: "5px" }}
                    width="50"
                  ...
                  <div className="card-body">
                    ...
                    <p
                      ...
                      style={{ fontSize: "13px", color: "grey" }}
                    >
                      Easily convert scanned PDF into <br></br>searchable and
