...
function ForgotPass() {
  ...
  const handleCaptchaVerification = () => {
    ...
    // You can set isCaptchaVerified to true here.
    ...
    <Container fluid className="login">
      <Row>
        ...
        <Col lg="7" md="12" sm="12" xs="12" className="text-center left-login">
          <div>
            <br/>
            <img  style={{width:'200px',filter:'contrast(10)' }}src={RedoPPDF} alt="" />
            <br />
            <br />
            ...
            <div className="login-form">
              ...
              {/* <a href="/" className="login-anchor">forgot your password</a>
                <br /> <br /> */}
              <div>
                <p>please confirm that you are not bot</p>

                <ReCAPTCHA
                  sitekey="6LfCtpkoAAAAABb99OToMp1bNCqnNXkfzRSIVF5W"
