      ...
      <div className="container-fluid">
        ...
        <div className={`collapse navbar-collapse ${isNavOpen ? 'show' : ''}`} id="navbarSupportedContent">
          ...
          >
            ...
            <li className="nav-item for-mobile">
              <Link className="nav-link active" to="splitpdf">
                SPILT PDF
              </Link>
            </li>
            <li className="nav-item for-mobile">
              <Link className="nav-link active" to="compresspdf">
                COMPRESS PDF
              </Link>
            </li>

            <li className="nav-item dropdown for-mobile">
              <a
                          ...
                          <i className="ico-drop">
                            ...
                            >
                              ...
                              <g fill="#fff">
                                ...
                                <use fillRule="nonzero" xlinkHref="#A"></use>
                                <mask>
                                  <use xlinkHref="#B"></use>
                                </mask>
                                <use fillRule="nonzero" xlinkHref="#B"></use>
                                <ellipse
                                  cx="22"
                                  cy="49.92"
                                  rx="5.143"
          ...
          <form className="d-flex form-login-signup">
            ...
            &nbsp;
            <Link to="/create-account" className="btn btn-outline-success form-mobile2" type="submit">
              Sign up
            </Link>
          </form>
        </div>
