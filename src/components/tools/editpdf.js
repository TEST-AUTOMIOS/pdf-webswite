  ...
  return (
    <div className="tools-height">
      <div className="text-center pdf-text1">
        <h1 className="pdf-text2">PDF Editor</h1>
        <p className="pdf-text3">
        Edit PDF by adding text, shapes, comments and highlights. Your secure and 
                     simple tool to edit PDF.
        </p>
        <div>
